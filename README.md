...
>>Change filepath to -> /usr/local/tomcat9/webapps/ROOT/WEB-INF/secured/x.txt (x/y/z/only secured - depending on one at place); In db.java, set imagepath to /usr/local/img/ 
